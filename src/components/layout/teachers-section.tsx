...
• Разбор сессии и рекомендации по развитию навыков`
  ...
  const inaraCourses = [
    {
      id: 1,
      title: "Возрастная Психология и Психология Развития",
...
• Детерминанты психологического развития
            ...
            >
              <TeacherCard>
                <CardHeader>
                  ...
                  <TeacherInfo>
                    <TeacherName>Юлия Гайдаева</TeacherName>
                    <TeacherTitle>Психолог-консультант, гипнолог, арт-терапевт</TeacherTitle>
                  </TeacherInfo>
                </CardHeader>
                
                <CardBody>
                  <DesktopTeacherName>Юлия Гайдаева</DesktopTeacherName>
                  ...
                  {activeTabJulia === 'biography' && (
                    <TabContent>
                      <p>
                        Я, Юлия Гайдаева, психолог-консультант, гипнолог, арт-терапевт, также работаю в методе ольфактотерапии (психологическая работа через эфирные масла).
                      </p>
                    ...
                    <TabContent>
                      <ContentSection>
                        ...
                        <ContentSection>
                          ...
                          <StyledList>
                            <ListItem>
                              <strong>Психологическое консультирование (парное, семейное, индивидуальное):</strong>
                              <p>Совмсестная работа, направления на помощь в решении различного рода психологических проблем и запросов, помощь в преодолении кризисов, в поиске ресурсов и т.д.</p>
                            </ListItem>
                  ...
                  {activeTabJulia === 'education' && (
                    <TabContent>
                      <ContentSection>
                        <SectionHeading>Образование и квалификации</SectionHeading>
                        <StyledList>
                          <ListItem>Дипломированный психолог-консультант</ListItem>
                          <ListItem>Повышение квалификации по направлению: «Эриксоновский гипноз и психотерапия»</ListItem>
                          <ListItem>Ольфактотерапия. Французская школа интергативной ароматерапии</ListItem>
                          <ListItem>Арома-баланс. Французская школа интергативной ароматерапии</ListItem>
                          <ListItem>Биохимия эфирных масел. Французская школа интергативной ароматерапии</ListItem>
                        </StyledList>
                      </ContentSection>
                    </TabContent>
                  )}
